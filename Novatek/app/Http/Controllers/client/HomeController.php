...
class HomeController extends Controller
{
    ...
    public function search(Request $request){
        ...
        if($request->get('query') != '')
        {
            ...
            { 
               $output .= '
               <div style="font-size:30px;margin-left:440px"><img style="width:50px;height:50px" src="images/product/'.$row->product_main_image.'" alt=""><a style="margin-left:30px" href="product/'.$row->product_id.'">'.$row->product_name.'</a></div>
               ';
           }
           echo $output;
       }else{
