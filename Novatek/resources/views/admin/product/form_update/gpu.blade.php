        ...
        <div class="row">
            <div class="col">
                ...
                {{-- spec type --}}
                    <div class="form-group">
                        Memory
                       <input type="text" name="gpu_memory" value="{{$gpu->gpu_memory}}" class="form-control" style="width:200px">
                   </div>
                <div class="form-group">
                    Speed
                    <input type="text" name="gpu_speed" value="{{$gpu->gpu_speed}}"  class="form-control" style="width:200px">
               </div>
               <div class="form-group">
                    Type
                    <input type="text" name="gpu_type" value="{{$gpu->gpu_type}}" class="form-control" style="width:200px">
                </div>
                {{-- end spec type --}}
            </div>
            <div class="col">
