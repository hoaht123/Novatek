                ...
                {{-- spec type --}}
                    <div class="form-group">
                        ...
                        <select name="headphone_micro" class="form-control" style="width:200px">
                            <option {{$headphone->headphone_micro == 'Yes'?'selected="selected"': ''}} value="Yes">Yes</option>
                            <option {{$headphone->headphone_micro == 'No'?'selected="selected"': ''}} value="No">No</option>
                        </select>
                   </div>
                <div class="form-group">
                    Wireless support
                    <select name="headphone_wireless" class="form-control" style="width:200px">
                        <option {{$headphone->headphone_wireless == 'Yes'?'selected="selected"': ''}} value="Yes">Yes</option>
                        <option {{$headphone->headphone_wireless == 'No'?'selected="selected"': ''}} value="No">No</option>
                    </select>
               </div>
               <div class="form-group">
                    Type
                    <select name="headphone_type" class="form-control"style="width:200px">
                        <option {{$headphone->headphone_type == 'in-ear'?'selected="selected"': ''}} value="in-ear">in-ear</option>
                        <option {{$headphone->headphone_type == 'over-ear'?'selected="selected"': ''}} value="over-ear">over-ear</option>
                    </select>
                </div>
                {{-- end spec type --}}
            </div>
