                ...
                <div class="content-margins">
                    <div class="row">
                        ...
                        <div class="col-xs-9 col-sm-11 text-right">
                            ...
                            <div class="header-bottom-icon toggle-search"><i class="fa fa-search" aria-hidden="true" style="top:9px"></i></div>
                    ...
                    <div class="header-search-wrapper">
                        <div class="header-search-content" style="background:rgba(0, 0, 0, 0.9); color:#fff">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                            ...
                                            <div class="search-submit">
                                                <i class="fa fa-search" aria-hidden="true" style="top:13px"></i>
                                                <input type="submit"/>
                                            </div>
                                ...
                                <div class="row" style="margin-top:10px; padding-right:100px" id="search_value">
