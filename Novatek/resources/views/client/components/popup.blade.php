        ...
        <div class="popup-container size-1">
            <div class="popup-align">
                ...
                <form action="{{URL::to('/register')}}" method="post">
                    @csrf
                    <div class="empty-space col-xs-b30"></div>
                    <input class="simple-input" type="text" value="" name="user_name" placeholder="Your name" />
                    <div class="col-xs-b10 col-sm-b20">sadasdasdasdasdas</div>
                    <input class="simple-input" type="text" value="" name="user_email" placeholder="Your email" />
                    <div class="empty-space col-xs-b10 col-sm-b20"></div>
                    <input class="simple-input" type="text" value="" name="user_phone" placeholder="Your phone" />
                    <div class="empty-space col-xs-b10 col-sm-b20"></div>
                    <input class="simple-input" type="text" value="" name="user_address" placeholder="Your address" />
                    <div class="empty-space col-xs-b10 col-sm-b20"></div>
                    <input class="simple-input" type="password" value="" name="user_password" placeholder="Enter password" />
                    <div class="empty-space col-xs-b10 col-sm-b20"></div>
                    <input class="simple-input" type="password" value="" name="user_repeat_password" placeholder="Repeat password" />
                    <div class="empty-space col-xs-b10 col-sm-b20"></div>
                    <div class="row">
